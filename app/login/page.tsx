...
export default function LoginPage() {
  ...
  const focusInput  = (e: React.FocusEvent<HTMLInputElement>) => { e.currentTarget.style.borderColor = "var(--color-accent)"; };
  const blurInput   = (e: React.FocusEvent<HTMLInputElement>) => { e.currentTarget.style.borderColor = "var(--color-border)"; };
  ...
  return (
    <main style={{
      ...
      <div style={{
        ...
        {/* Back to portfolio link — matching prototype */}
